...
export class my_nft_marketPlace__getListingResultValue0Struct extends ethereum.Tuple {
  get price(): BigInt {
...
export class my_nft_marketPlace extends ethereum.SmartContract {
  static bind(address: Address): my_nft_marketPlace {
    return new my_nft_marketPlace("my_nft_marketPlace", address);
  }

  getListing(
    nftAddress: Address,
    tokenId: BigInt
  ): my_nft_marketPlace__getListingResultValue0Struct {
    ...
    return changetype<my_nft_marketPlace__getListingResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_getListing(
    nftAddress: Address,
    tokenId: BigInt
  ): ethereum.CallResult<my_nft_marketPlace__getListingResultValue0Struct> {
    ...
    return ethereum.CallResult.fromValue(
      changetype<my_nft_marketPlace__getListingResultValue0Struct>(
        value[0].toTuple()
      )
    );
  }
